...
toss <- results %>% 
  filter(!new_recap_id %in% keep$new_recap_id)

results <- results %>% 
  filter(!new_recap_id %in% toss$new_recap_id)

new_fish_recaps <- left_join(fish_recaps, results, by = "fish_table_id")

new_fish_recaps <- new_fish_recaps %>% 
