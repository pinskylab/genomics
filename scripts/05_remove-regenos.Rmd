...
```{r}
# load data
download.file("https://github.com/pinskylab/genomics/raw/master/data/seq33_03_baits_only_SNPs.gen", destfile = "baits-only-snps.gen")
genedf_raw <- read_genepop("baits-only-snps.gen")
file.remove("baits-only-snps.gen")
