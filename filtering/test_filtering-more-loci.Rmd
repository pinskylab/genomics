...
echo "FILTER SNP CONTIG INDV" > Filter.count
  ...
  echo "step6a.recode.vcf $FILTER $SNP $CONTIG $INDV" >> Filter.count
...
echo "FILTER SNP CONTIG INDV" > Filter.count
  ...
  echo "step6b.recode.vcf $FILTER $SNP $CONTIG $INDV" >> Filter.count
...
echo "FILTER SNP CONTIG INDV" > Filter.count
  ...
  echo "step7a.recode.vcf $FILTER $SNP $CONTIG $INDV" >> Filter.count
...
echo "FILTER SNP CONTIG INDV" > Filter.count
  ...
  echo "step7b.recode.vcf $FILTER $SNP $CONTIG $INDV" >> Filter.count
