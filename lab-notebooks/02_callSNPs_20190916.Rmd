...
# Setup  
**Find and replace each 20190916 with the current date and replace the "template" in this call_SNPs document filename with your analysis date.**
...
```
3194 individuals
20 out of 40 processors
120 out of 252 max memory
yes trim
no assemble
yes map
no new parameters
